   ...
   <script type="text/javascript">
            ...
            $("#login-button").click(function () {
            	if (!$("#userId").val()) {
            	    ...
            	    return;
                	 ...
                	 $("#register").attr("action", "${root}/user/register").submit();
                }
            });
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="http://127.0.0.1:5500/happyhousefront-master/screen/notice.html">공지사항</a>
            </li>
        </ul>
        </div>
    </div>
	...
	<div class="form-wrapper">
		<div class="form-container">
			...
			<form class="form" id="register" method="post" action="">
				<input type="hidden" name="siginup" id="siginup">
